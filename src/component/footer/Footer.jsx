        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            ...
            <p class="hover:underline text-white cursor-pointer">
              ...
              23+ years of experience in joint replacement surgery.
            </p>
            <Link
              to="/about"
            ...
            <div className="flex gap-4 mt-4" aria-label="Social media links">
              <a
                ...
                aria-label="Visit Dr. Amit Sharma's Facebook profile"
                title="Facebook"
                role="link"
                className={hoverLink}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit Dr. Amit Sharma's LinkedIn profile"
                title="LinkedIn"
                role="link"
                className={hoverLink}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit Dr. Amit Sharma's Instagram profile"
                title="Instagram"
                role="link"
                className={hoverLink}
              >
