    ...
    <main>
      ...
      >
        <img
          ...
          title="Sports injury care and treatment banner"
        ...
        <div className="relative z-10 h-full flex items-center justify-start">
          <div className="max-w-3xl px-4 md:px-32 text-center md:text-left">
            <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-snug">
              Best Sports Injury Treatment with Modern Therapies In Ghaziabad
            </h1>
            <p className="text-white text-base md:text-lg mb-4 max-w-xl">
              Trusted by athletes for expert orthopedic care, injury prevention,
              and fast recovery across Ghaziabad and Ghaziabad .
            </p>
            <nav
            ...
            >
              ...
              <Link to="/service" className="hover:underline font-bold">
                Services
              </Link>
              <ChevronRight className="w-4 h-4" />
      ...
      <section className="py-10 bg-white" role="main">
        <div className="max-w-7xl mx-auto lg:flex lg:gap-8 px-4">
          ...
          <div className="lg:w-3/4 w-full">
            <figure className="rounded overflow-hidden shadow-md mb-6">
              <img
                ...
                title="Physiotherapy for sports injury recovery"
            ...
            >
              <header>
                ...
                <p className="mb-6" itemProp="description">
                  Sports injuries affect athletes and active individuals alike.
                  Our goal is fast, safe, and complete recovery using modern
                  diagnostics, physiotherapy, and advanced surgical care when
                  needed.
                </p>
              </header>
              ...
              {[
                ...
                },
                {
                  ...
                  items: [
                    ...
                    "Trusted by athletes in Ghaziabad ",
                  ],
                },
              ].map(({ heading, items }, i) => (
                <section key={i}>
              ...
              <div
                className="bg-blue-50 p-6 rounded text-center mt-10"
                role="complementary"
              >
                ...
                <p className="text-sm mb-4">
                  Schedule a consultation with Dr. Amit Sharma and get back in
                  action sooner.
                </p>
                <Link
                  to="/contact"
          ...
          {/* Sidebar */}
          <aside
            className="lg:w-1/4 w-full mt-10 lg:mt-0 space-y-6"
            aria-label="Sidebar"
          >
            <nav
            ...
            <section
              className="bg-white text-gray-800 p-4 rounded shadow-sm border"
              aria-labelledby="opd-heading"
            >
              <p id="opd-heading" className="text-lg font-semibold mb-3">
                OPD Timings
              </p>
              <ul className="text-sm space-y-2" aria-label="OPD Details">
                ...
                <li className="text-center text-xs mt-2">
                  ...
                  <br />
                  Opp. Swarn Cinema, near Surya Hospital, Ghaziabad
                  <br />
                  Call:{" "}
